...
model_folder_dir = '/data0/qilei_chen/Development/Datasets/KAGGLE_DR/inceptionv3_models_1280_with_deephead'
...
def initialize_model(model_name, num_classes, feature_extract, use_pretrained=True):
    ...
    if model_name == "resnet":
        ...
        """
        model_ft = models.inception_v3(pretrained=use_pretrained,with_deephead_v2=True)
        set_parameter_requires_grad(model_ft, feature_extract)
