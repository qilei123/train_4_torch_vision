...
model_folder_dir = data_dir+'/models_3000_inceptionv3_kernel_15_stride_5_wider1'
...
record_file = open('val_binary_3000_inception_k15_s5_wider_record.txt','w')
for img in imgs:
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
    ...
    for epoch in range(resume,num_epochs):
        ...
        print('-' * 10)
        record_file = open('Epoch_'+str(epoch)+'_val_binary_3000_kernel_15_stride5_inception_wider_record.txt','w')
        ...
        for phase in ['train_binary', 'val_binary']:
            ...
            if phase =='train_binary':
                ...
                dataloaders[phase] = torch.utils.data.DataLoader(image_datasets[phase], batch_size=batch_size, shuffle=False, num_workers=4)
            # Iterate over data.
