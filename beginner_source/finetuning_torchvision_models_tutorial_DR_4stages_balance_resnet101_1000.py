...
data_dir = "/data0/qilei_chen/AI_EYE/kaggle_data/dataset_4stages_balance"

# Models to choose from [resnet, alexnet, vgg, squeezenet, densenet, inception]
model_name = "resnet"
model_folder_dir = data_dir+'/resnet101_models_1000'
...
if resume>0:
    checkpoint = torch.load(model_folder_dir+'/resnet_epoch_'+str(resume)+'.pth')
