...
parser.add_argument('--datadir', '-d', help='set the training dataset', default="/data1/qilei_chen/DATA/DB_NATURAL/data1")
...
model_folder_dir = data_dir+'/finetune_natural_retina_'+model_name
