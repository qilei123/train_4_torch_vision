...
data_dir = "/data0/qilei_chen/AI_EYE/Messidor/dr_binary"
# Models to choose from [resnet, alexnet, vgg, squeezenet, densenet, inception]
model_name = "resnet101_wider"

model_folder_dir = data_dir+'/models_1500_resnet101_kernel_15_stride_5_wider'
...
record_file = open('val_binary_1500_resnet101_kernel_15_stride_5_wider_record.txt','w')
for img in imgs:
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
    ...
    for epoch in range(resume,num_epochs):
        ...
        print('-' * 10)
        record_file = open('Epoch_'+str(epoch)+'_val_binary_1500_resnet101_kernel_15_stride_5_wider_record.txt','w')
